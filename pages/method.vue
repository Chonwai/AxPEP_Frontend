        ...
        <div class="p-8">
            <section id="AxPEP-Server" class="mb-8">
                ...
                <p>
                    ...
                    toxicity. Some AMPs also display antitumor and antivirus functions making them
            ...
            <section id="Antimicrobial-Peptide-Prediction" class="mb-8">
                ...
                <p>
                    ...
                    positive:negative data ratios by 10-fold cross-validation. Our optimal model,
                    AmPEP with 1:3 data ratio achieved a very high accuracy of 96%, MCC of 0.9,
                    AUC-ROC of 0.99 and Kappa statistic of 0.9. Descriptor analysis by Pearson
                    correlation coefficients of AMP/non-AMP distributions revealed that reduced
                    feature sets (from full-feature of 105 to minimal-feature of 23) can achieve
                    comparable performance in all aspects except some reductions in precision.
                    Furthermore, AmPEP achieved high performance in terms of AUC-ROC (0.995), AUC-PR
                    (0.957), MCC (0.921) and kappa (0.962) using a benchmark dataset. Our
                    performance is 1-5% better than two published methods iAMPpred and iAMP-2L.
                </p>
                <v-card class="mx-auto w-4/5 mb-8">
                    ...
                    <v-card-subtitle class="pb-0 flex justify-center items-center"
                        >Figure 2: The prediction model of AmPEP is based on random forest
                        (originally implemented in MATLAB, but now in R for online
                        server).</v-card-subtitle
                    >
                </v-card>
                <p>
                    This online prediction model has been reimplemented in R and tested to achieve
                    very close accuracy to our original MATLAB implementation used for publication.
                    If you want to run the MATLAB code yourself, feel free to
                ...
                <v-card class="mx-auto w-4/5 mb-8">
                    <v-card-text>
                        ...
                        <div class="text--primary">
                            Pratiti Bhadra, Jielu Yan, Jinyan Li, Simon Fong, and Shirley W. I.
                            Siu.*
                        </div>
                    </v-card-text>
                </v-card>
            ...
            <section id="Deep-AmPEP30" class="mb-8">
                ...
                <p>
                    ...
                    existing AMP prediction methods often mixing long sequences and short sequences
                    in both the training and validation of the prediction model, we found out that
                    their prediction accurcies are surprisingly low (60-77%) for short AMPs. To meet
                    the needs of short AMP prediction, we developed Deep-AmPEP30. This is a
                    sequence-based classification method using selected types of PseKRAAC reduced
                    amino acids composition as features (see Figure 3) and convolutional neural
                    network as learning algorithm. Deep-AmPEP30 was tuned to optimize the prediction
                    of short AMPs of 30 AA or less in length and tested to achieve good performances
                    in accuracy 83%, AUC-ROC 0.92 and AUC-PR 0.94.
                </p>
                <v-card class="mx-auto w-4/5 mb-8">
                    <v-img
                        class="white--text align-end w-2/3 m-auto"
                    ...
                    <v-card-subtitle class="pb-0 flex justify-center items-center"
                        >Figure 3. Steps to generate the feature vector of an example peptide
                        sequence using PseKRAAC feature Type 7-Cluster 15.
                    </v-card-subtitle>
                </v-card>
                <v-card class="mx-auto w-4/5 mb-8">
                    <v-img
                ...
                <v-card class="mx-auto w-4/5 mb-8">
                    <v-card-text>
                        ...
                        <p>Submitted.</p>
                        <div class="text--primary">
                            Pratiti Bhadra, Jielu Yan, Ang Li, Pooja Sethiya, Longguang Qin, Hio
                            Kuan Tai, Koon Ho Wong, and Shirley W. I. Siu.*
                        </div>
                    </v-card-text>
                </v-card>
            </section>
            <section id="AcPEP" class="mb-8">
                ...
                <p>
                    ...
                    Because short-chain anticancer peptides display high specificity and low
                    toxicity, they are believed to be a promising solution as the next generation of
                    cancer therapeutics.
                </p>
                <p>
                    ...
                    characterizes the ability of peptides to partition into the surface and center
                    of cell membranes. Using three independent datasets, we compared our models to
                    ...
                    leave-one-out cross-validation. Our prediction accuracy is in the range of
                    92-96% in all three datasets, with Matthew's correlation coefficient 2-11% above
                ...
                <p>
                    ...
                    improved by adopting cancer membrane models in the theoretical calculation of
                    the transfer free energy scale.
                </p>
                <v-card class="mx-auto w-4/5 mb-8">
                    <v-card-text>
                        <div>Reference</div>
                        <p class="text-base font-bold text--primary">
                            ...
                            acid composition, profile similarity, and water-membrane partitioning
                            free energy.
                        </p>
