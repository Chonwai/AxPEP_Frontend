<template>
    <div class="p-0 md:p-8">
        ...
        <v-stepper class="stepper-container" v-model="e6" vertical>
            ...
            <v-stepper-step :complete="e6 > 2" step="2">Job Description (optional)</v-stepper-step>
            ...
            <v-stepper-step step="3">Create account to retrieve all submitted jobs</v-stepper-step>
